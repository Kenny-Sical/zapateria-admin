...
@section('title', 'Nuevo Usuario - Lizz Glamour')
...
<div class="card form-card">
    <h3 style="margin-bottom: 1.5rem; color: var(--text-primary); font-weight: 600;">
        <i class='bx bx-user-plus' style="color: var(--primary-color); vertical-align: middle; font-size: 1.5rem; margin-right: 0.5rem;"></i>
        Crear Nuevo Usuario
    </h3>
    ...
    <form action="{{ route('users.store') }}" method="POST">
        ...
        <div class="form-group">
            <label for="password">Contraseña <span style="color: #D64545;">*</span></label>
        ...
        <div class="form-group">
            ...
            <select id="role" name="role" class="form-control" required>
                <option value="1" {{ old('role') == '1' ? 'selected' : '' }}>Editor (Solo Inventario)</option>
                <option value="0" {{ old('role') == '0' ? 'selected' : '' }}>SuperAdmin (Acceso Total)</option>
            </select>
