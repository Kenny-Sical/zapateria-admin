...
@section('title', 'Nuevo Producto - Lizz Glamour')
@section('header_title', 'Inventario > Nuevo Producto')
    ...
    <form id="productForm" action="{{ route('inventory.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="step-content" id="step-2">
            ...
            <p style="color: var(--text-secondary); margin-bottom: 1.5rem; font-size: 0.875rem;">
                Ingresa las cantidades para cada combinación de Talla y Color como si fuera una hoja de cálculo de Excel.
            </p>
        ...
        <div class="wizard-actions">
            ...
            <div>
                ...
                <button type="submit" class="btn btn-success" id="btnSubmit" style="display: none;">Guardar Producto</button>
            </div>
        </div>
    </form>
</div>
...
@section('scripts')
    <script src="{{ asset('js/inventory/create.js') }}?v={{ time() }}"></script>
@endsection
